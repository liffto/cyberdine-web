...
const WelcomePage = ({ data, restId, table, bgColor }: { data: any, restId: string; table: string, bgColor: string; }) => {
    ...
    const items = [
        ...
        { svg: '/images/svg/welcome_page/drinks_menu_icon.svg', text: data.id == "TOW151224htl" ? 'View AC Menu' : 'View Drinks Menu', type: 'drinksMenu', showCard: data.businessType == "restroBar", link: `/rest/${restId}/menu?table=${table}` },
