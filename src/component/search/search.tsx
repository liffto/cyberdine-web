...
export default function SearchComponent({
  ...
  function TopBar() {
    return (
      <div className="sticky top-0 bg-white z-40 bg-white">
        <div className="px-4 md:container pt-2 pb-3">
          <TextField
            placeholder="Search"
            fullWidth
            value={query ?? ""}
  ...
  const inputStyles = {
    '& .MuiInputBase-input': {
      ...
      padding: '8px 0px', // Adjust padding to reduce height
      height: 'auto'
    },
    '& .MuiOutlinedInput-root': {
      ...
      minHeight: '20px', // Adjust this value as needed
    },
  ...
  return (
    <div className="bg-[#fafafa]">
      ...
      />}
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 md:gap-6 pb-4 ">
        {menu &&
          ...
          Array.from(
            ...
            return (
              <div className="" key={index}>
                <div className="" >
                  <div className={`sticky ${menuType == "foodMenu" ? "top-[100px]"  : "top-[59px]"} bg-white z-10 `}>
